...
public class RouteRepository : IRouteRepository
{
    ...
    private static Dictionary<int, List<(int to, double w)>> BuildAdjacency(PathModel[] paths)
    {
    ...
    private static int[] ToPathIds(PathModel[] paths, int[] nodeIds)
    {
    ...
    private static double ComputeLength(PathModel[] paths, int[] nodeIds)
    {
        var sum = 0.0;
        for (var i = 0; i + 1 < nodeIds.Length; i++)
        {
