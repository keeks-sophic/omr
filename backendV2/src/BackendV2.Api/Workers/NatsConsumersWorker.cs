...
public class NatsConsumersWorker : BackgroundService
{
    ...
    private NATS.Client.JetStream.IPushAsyncSubscription? _stateSnapshot;
    private NATS.Client.JetStream.IPushAsyncSubscription? _stateEvent;
    private NATS.Client.JetStream.IPushAsyncSubscription? _battery;
    private NATS.Client.JetStream.IPushAsyncSubscription? _health;
    private NATS.Client.JetStream.IPushAsyncSubscription? _pose;
    private NATS.Client.JetStream.IPushAsyncSubscription? _motion;
    private NATS.Client.JetStream.IPushAsyncSubscription? _radar;
    private NATS.Client.JetStream.IPushAsyncSubscription? _qr;
